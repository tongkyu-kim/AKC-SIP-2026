// One shared 5-stage pipeline for every category (vip/speaker/moderator/
// participant/organizer alike) — previously "confirmed" meant blue for
// speakers but green for participants (and "contacted" the reverse), which
// read as broken/inconsistent across rosters. Now the word and the color
...
export const STATUSES: SpeakerStatus[] = ["backup", "unavailable", "shortlisted", "confirmed", "prepared"];
...
export const STATUS_STYLE: Record<SpeakerStatus, string> = {
  ...
  unavailable: "bg-red-100 text-red-700 ring-red-300 dark:bg-red-950 dark:text-red-300 dark:ring-red-700",
  shortlisted: "bg-yellow-100 text-yellow-700 ring-yellow-300 dark:bg-yellow-950 dark:text-yellow-300 dark:ring-yellow-700",
  confirmed: "bg-blue-100 text-blue-700 ring-blue-300 dark:bg-blue-950 dark:text-blue-300 dark:ring-blue-700",
  prepared: "bg-emerald-100 text-emerald-700 ring-emerald-300 dark:bg-emerald-950 dark:text-emerald-300 dark:ring-emerald-700",
};
